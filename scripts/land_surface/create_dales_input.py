...
def process_input(lu_types, parnames, domain, era5_path, output_path, spatial_data_path, start_date, exp_id, ktot_soil, lwrite, lplot):
...
if __name__ == "__main__":
    ...
    spatial_data_path = "/archive/work_F/weather_simulation/ruisdael_data/spatial_data/"
    ...
    start_date = datetime(year=2018, month=6, day=1) #, hour=4)
